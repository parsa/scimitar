...
#
_move_cursor                     = lambda row, column: '\033[{ROW};{COLUMN}H'.format(ROW=row, COLUMN=column)
move_cursor                      = lambda row, column: apply(move_cursor(row, column))
#
_move_cursor_2                   = lambda row, column: '\033[{ROW};{COLUMN}f'.format(ROW=row, COLUMN=column)
move_cursor_2                    = lambda row, column: apply(move_cursor_2(row, column))
#
_direct_cursor_addr              = lambda row, column: '\033Yn{ROW}c{COLUMN}'.format(ROW=row, COLUMN=column) # Direct cursor addressing (line/column number)
direct_cursor_addr               = lambda row, column: apply(_direct_cursor_addr(row, column))
#
