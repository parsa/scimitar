...
#
_delete_n_chars                  = lambda count=1: '\033[{COUNT}P'.format(COUNT=count) # Delete n characters from cursor position
...
#
_delete_n_lines                  = lambda count=1: '\033[{COUNT}M'.format(COUNT=count) # Delete n lines from cursor position down
